...
echo [+] Launching API Gateway (Port 8111)...
start "API Gateway [8111]" /min cmd /c "cd /d C:\odoo project\Human-Resource-Management-System\backend\api-gateway && .\mvnw.cmd spring-boot:run"
